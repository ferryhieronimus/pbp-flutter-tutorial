                                ...
                                children: <Widget>[
                                  ...
                                  Center(
                                      child: Column(children: [
                                        ...
                                        Padding(
                                          padding: EdgeInsets.all(10), //apply padding to all four sides
                                          child: Text('Jenjang: ${jenjangDoktor ? 'Doktor' : jenjangMagister ? 'Magister' : jenjangSarjana ? 'Sarjana' : jenjangDiploma ? 'Diploma' : 'None'}'),
                                        ),
                                        Padding(
                                          padding: EdgeInsets.all(10), //apply padding to all four sides
                                          child: Text('Umur: ${umur.round()}'),
                                        ),
                                        Padding(
                                          padding: EdgeInsets.all(10), //apply padding to all four sides
                                        ...
                                        Padding(
                                          padding: EdgeInsets.all(10), //apply padding to all four sides
                                          child: Text('Pratice: ${_nilaiSwitch ? 'on' : 'off'}'),
                                        ),
                                      ])
                                  ),
                                  TextButton(
